        ...
        <div className="grid gap-8 md:grid-cols-2 md:items-center">
          ...
          >
            ...
            <h2 className="font-display text-2xl font-bold tracking-tight text-foreground md:text-3xl">
              <span className="text-foreground">Kontrast</span> Festival
            </h2>
            ...
            <Link
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-lg border border-foreground bg-foreground px-5 py-2.5 text-sm font-medium text-background transition-colors hover:bg-foreground/90"
            >
              View Case Study
          ...
          {/* Right: Visual with play button — image is dark, so we keep the dark
              overlay + white text for legibility on the photo */}
          <motion.div
          ...
          >
            ...
            {/* Bottom label — sits on the dark image, so white text stays */}

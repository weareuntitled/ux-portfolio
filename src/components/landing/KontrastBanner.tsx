        ...
        <div className="grid gap-8 md:grid-cols-2 md:items-center">
          ...
          >
            ...
            <Link
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-lg border border-white bg-white px-5 py-2.5 text-sm font-medium text-black transition-colors hover:bg-white/90"
            >
              View Case Study

...
export function MentioningsPanel() {
  return (
    <aside className="flex w-64 shrink-0 flex-col rounded-lg border border-border bg-background p-3">
      <h3 className="mb-3 text-sm font-bold text-foreground">Mentionings</h3>
      <div className="flex flex-col gap-3 overflow-y-auto">
        {mentions.map((mention) => (
          <div key={mention.id} className="flex gap-2">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-1 rounded border border-border bg-muted/50 px-2 py-1.5">

...
const pageIcons: Record<string, React.ComponentType<{ className?: string }>> = {
  "/prototypes/ffp": Fingerprint,
  "/prototypes/ffp-review": BarChart3,
  "/prototypes/diss": Shield,
  "/prototypes/saga": MessageCircle,
  "/prototypes/diagnose": Activity,
  "/prototypes/forum": Users,
};
...
export function TopNavbar({ onGridToggle, showLogo }: TopNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-14 items-center justify-between border-b border-border bg-background px-4">
      ...
      <div className="flex items-center gap-2">
        <Button variant="ghost" size="icon" aria-label="Notifications" className="text-foreground hover:bg-secondary">

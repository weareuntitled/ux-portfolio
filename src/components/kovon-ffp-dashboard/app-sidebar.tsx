...
const navItems = [
  { label: "Dashboard Übersicht", icon: LayoutGrid, href: BASE },
  { label: "FFP", icon: Fingerprint, href: `${BASE}/reporting` },
  { label: "Diagnose", icon: Activity, href: "#" },
  { label: "DISS", icon: Shield, href: `${BASE}/diss` },
  { label: "SAGA", icon: MessageCircle, href: `${BASE}/saga` },
  { label: "Reporting", icon: BarChart3, href: `${BASE}/reporting` },

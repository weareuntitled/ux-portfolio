...
const navItems = [
  { label: "Dashboard Übersicht", icon: LayoutGrid, href: "/" },
  { label: "FFP", icon: Fingerprint, href: "/reporting" },
  { label: "Diagnose", icon: Activity, href: "#" },
  { label: "DISS", icon: Shield, href: "/diss" },
  { label: "SAGA", icon: MessageCircle, href: "/saga" },
